...
RUN apt-get update -y
RUN apt-get install -y php7.4 php7.4-mysql php7.4-gd php7.4-curl php7.4-apcu php7.4-cli php7.4-json php7.4-mbstring php7.4-fpm php7.4-zip php-pear nginx supervisor procps python-pygments
...
#copy startup script && remove apt cache files
